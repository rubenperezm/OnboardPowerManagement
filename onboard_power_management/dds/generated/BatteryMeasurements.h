...
#ifndef _FAST_DDS_GENERATED_DDS_BATTERYMEASUREMENTS_H_
#define _FAST_DDS_GENERATED_DDS_BATTERYMEASUREMENTS_H_
...
namespace dds {
    ...
    public:
         ...
         * @param x Reference to the object dds::BatteryMeasurements that will be copied.
         */
        eProsima_user_DllExport BatteryMeasurements(
         ...
         * @param x dds::BatteryMeasurements object to compare.
         */
...
#endif // _FAST_DDS_GENERATED_DDS_BATTERYMEASUREMENTS_H_