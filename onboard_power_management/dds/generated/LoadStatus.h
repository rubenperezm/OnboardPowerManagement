...
#ifndef _FAST_DDS_GENERATED_DDS_LOADSTATUS_H_
#define _FAST_DDS_GENERATED_DDS_LOADSTATUS_H_
...
namespace dds {
    ...
    public:
         ...
         * @param x Reference to the object dds::LoadStatus that will be copied.
         */
        eProsima_user_DllExport LoadStatus(
                const LoadStatus& x);
         ...
         * @param x dds::LoadStatus object to compare.
         */
...
#endif // _FAST_DDS_GENERATED_DDS_LOADSTATUS_H_